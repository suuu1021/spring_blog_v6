 ...
 * 기본적인 CRUD 제공
 */
// @Repository 생략 가능 --> JpaRepository 에 선언 되어 있음
public interface BoardJpaRepository extends JpaRepository<Board, Long> {

    // 기본 CRUD 기능 외 추가적인 기능은 직접 선언해주어야 한다.


    // 게시글과 사용자 정보가 포함된 엔티티를 만들어 주어야 한다. (게시글 리스트 용)
    ...
    // 게시글 ID로 한방에 유저 정보도 가져오기 - JOIN FETCH 사용하면 됨
